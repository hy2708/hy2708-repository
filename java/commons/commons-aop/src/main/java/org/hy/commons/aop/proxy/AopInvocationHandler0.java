...
public class AopInvocationHandler0 implements InvocationHandler{

	public AopInvocationHandler0(Object beProxiedObject, Advice[] advices) {
		super();
	...
	public AopInvocationHandler0(Object beProxiedObject) {
		super();
		this.beProxiedObject = beProxiedObject;
	}
	...
	public Object invoke(Object proxyObject, Method method, Object[] args)
		...
		if (CollectionUtil.isNotEmpty(aroundAdvices)) {
			...
			//}
				...
				ProceedingJoinPoint pjp = null;//new ProceedingJoinPointImpl(aroundAdvices,beProxiedObject,method,args);
				pjp.proceed();
