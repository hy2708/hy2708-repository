...
public class TreeHelper {
    ...
    private BiTree.TreeNode root;
    private List<BiTree.TreeNode> tempNodeList;
    private boolean isValidTree = true;

    public TreeHelper() {
    }

    public TreeHelper(List<BiTree.TreeNode> treeNodeList) {
        tempNodeList = treeNodeList;
        generateTree();
    }

    public static BiTree.TreeNode getTreeNodeById(BiTree.TreeNode tree, int id) {
        if (tree == null)
            return null;
        BiTree.TreeNode treeNode = tree.findTreeNodeById(id);
        return treeNode;
    }
    ...
    protected HashMap putNodesIntoMap() {
        ...
        HashMap nodeMap = new HashMap<String, BiTree.TreeNode>();
        Iterator it = tempNodeList.iterator();
        while (it.hasNext()) {
            BiTree.TreeNode treeNode = (BiTree.TreeNode) it.next();
    ...
    protected void putChildIntoParent(HashMap nodeMap) {
        ...
        while (it.hasNext()) {
            ...
            if (nodeMap.containsKey(parentKeyId)) {
                BiTree.TreeNode parentNode = (BiTree.TreeNode) nodeMap.get(parentKeyId);
                if (parentNode == null) {
    ...
    protected void initTempNodeList() {
        if (this.tempNodeList == null) {
            this.tempNodeList = new ArrayList<BiTree.TreeNode>();
        }
    }

    /** add a tree node to the tempNodeList */
    public void addTreeNode(BiTree.TreeNode treeNode) {
        initTempNodeList();
     ...
     */
    public boolean insertTreeNode(BiTree.TreeNode treeNode) {
    ...
    public BiTree.TreeNode getRoot() {
        return root;
    }

    public void setRoot(BiTree.TreeNode root) {
        this.root = root;
    }

    public List<BiTree.TreeNode> getTempNodeList() {
        return tempNodeList;
    }

    public void setTempNodeList(List<BiTree.TreeNode> tempNodeList) {
