...
public class T03_0 {
	...
	public static void main(String[] args) throws Exception {
		String path ="E:\\导师\\java\\实验3\\" +
				"__3_3901140231_3901140231_1406________";
		...
		ClassLoaderUtil.compile(path+"\\" +	fileNamePre+"1"+".java","gbk");
		ClassLoaderUtil.compile(path+"\\" +	fileNamePre+"2"+".java","gbk");
		ClassLoaderUtil.compile(path+"\\" +	fileNamePre+"3"+".java","gbk");
		ClassLoaderUtil.compile(path+"\\" +	fileNamePre+"4"+".java","gbk");
		loadOthers(path, "");
		ClassLoaderUtil.compile2(path+"\\" +	"Aa"+".java","gbk","-cp",path+"\\" );
