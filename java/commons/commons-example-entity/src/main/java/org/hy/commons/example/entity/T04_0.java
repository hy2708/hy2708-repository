...
public class T04_0 {
	...
	public static void main(String[] args) throws Exception {
		String path ="E:\\导师\\java\\实验4_hhy\\" +
				"__4_3901140333_____1406_3901140333____" ;

		path=getFinalPath(path);
		System.out.println("Final Path  "+path);
		//ClassLoaderUtil.compile(path+"\\" +"Fan.java",charset);
		//ClassLoaderUtil.compile(path+"\\" +"Location.java",charset);
		//ClassLoaderUtil.compile(path+"\\" +"QuadraticEquation.java",charset);
		System.out.println("============================================");
		...
		*/
		...
		testCases01.add("abcaba a");
		testCases01.add("abcdefa a");
		testCases01.add("abcdefa g");
	...
	public static String getFileNamePre(String path) throws Exception {
		...
		for (String string : fileNames) {
			if (string.endsWith("1.java")) {
				...
				if (fileNames.contains(pre+"3.java")&&fileNames.contains(pre+"2.java")) {
					return pre;
				}else {
					pre=null;
				}
	...
	public static void testDemo01(String path,String className,List<String> inputstreamTestCases,List<String> mainArgs,String packagePre) throws Exception {
		...
		FileUtil.replaceLine(path+"\\" +
				className+".java", 0, 5, "package", ";", charset);
