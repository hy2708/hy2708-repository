...
public class RequestDispatcherServlet_Include extends HttpServlet {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		JettyUtil.getWebAppContext().addServlet(RequestDispatcherServlet_Include.class, JettyUtil.HELLO);
...
//		RequestDispatcher dispatcher = request.getRequestDispatcher("testRequestServlet");
		...
		logger.info("【" +
				...
				"】转发给【" +
				TestRequestServlet.class.getSimpleName()+
				"】之前");
		/*
		 * //没有发送到浏览器
		 */
