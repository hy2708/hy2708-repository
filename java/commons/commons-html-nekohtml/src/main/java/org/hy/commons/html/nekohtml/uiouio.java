...
public class uiouio {
	public static void main45645(String[] args) throws XPathException, TransformerException {
...
//        for(int i=0; i< products.getLength();i++)  
		...
		{  
			...
			//////////////////////////////////////////////////////////////
        	String itemIdentifier = element.getAttribute("id");
			...
			System.err.println(itemIdentifier +" ----"+commodityItemUrl+commodityItemName);
		///////////////////////////////////////////////////////////////
			...
			//////////////////////////////////////////////////////////////
				...
				System.err.println("市场价"+marketPriceStr);
			///////////////////////////////////////////////////////////////
				...
				System.err.println("成交价"+auctionPrice);
			///////////////////////////////////////////////////////////////
				...
				System.err.println(customerName+commodityItemUrl);
			///////////////////////////////////////////////////////////////
    ...
    public static void main68768(String[] argv) throws Exception {  
