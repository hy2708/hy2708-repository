 ...
 * generated in the org.hy.commons.web.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _Say_QNAME = new QName("http://webservice.web.commons.hy.org/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://webservice.web.commons.hy.org/", "sayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.hy.commons.web.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.web.commons.hy.org/", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.web.commons.hy.org/", name = "sayResponse")
