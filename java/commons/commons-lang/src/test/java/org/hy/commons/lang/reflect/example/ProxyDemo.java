...
public class ProxyDemo {
	...
	private static Logger logger = LoggerFactory.getLogger(ProxyDemo.class);
...
//		list2.add("ddd");
	...
	public void testProxyClass() {
		Class<?> clazz = Proxy.getProxyClass(SimpleObject.class.getClassLoader(), SimpleObject.class.getInterfaces());
		Constructor<?>[] constructors = clazz.getConstructors();
		for (Constructor<?> constructor : constructors) {
			logger.debug("构造方法是"+constructor.getName()+" 参数是【 {}】",constructor.getParameterTypes());
		}
	}
