...
public class StringUtilTest {
	...
	public static void main(String[] args) {
		String string = "adfb.adf.sdf.  .";
		String[] arr =string.split("\\.");
		int count =0;
		for (int i = 0; i < arr.length; i++) {//ju 
	...
	public void name() throws UnsupportedEncodingException {
		...
		System.err.println("原"+stringBuilder.toString().length()+"  "+b.length);
		String string = new String(b);
		byte[] b2 = string.getBytes("utf-8");
		System.err.println("后"+string.length()+"  "+b2.length);
	...
	@Test
	public void testIsHexStringChar() {
		fail("Not yet implemented");
	}
	...
	public void testParseTemplate() {
		InputStream inputStream=getClass().getClassLoader().getResourceAsStream("IEntityDao.template");
		String string =StringUtil.parseTemplate(inputStream, new HashMap<String, Object>());
	...
	public void testReplace() {
		...
		assertEquals("qwe2qwe4qwe", StringUtil.replace(src22, "3", "qwe"));
